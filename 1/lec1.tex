...
\eventtitle{Podstawy Programowania}
\title{Podstawy Programowania}
\author[shortname]{Stanis{\l}aw Gepner}
\institute[shortinst]{room 117,\\ stanislaw.gepner@pw.edu.pl, sgepner@meil.pw.edu.pl}
\date{}
...
\begin{frame}{Resources}
  \begin{itemize}
    ...
    \item Online compilers \url{https://godbolt.org/}
  ...
  \begin{columns}
    \begin{column}{0.49\textwidth}
      \begin{itemize}
        ...
        \item Or was it Charles Babbage (1791-1871)?
      \end{itemize}
    \end{column}
    \begin{column}{0.49\textwidth}
      \centering
...
\frame{
  \frametitle{ C language}
    \begin{itemize}
      ...
      \end{itemize}
      \item Many of the mannerisms of C have been adapted by many descendent languages. == to test for equality. \&\& for boolean AND, and \& for bitwise AND. << and >> for bit shifting. \% for modular arithmetic. Braces {} for code blocks. Now these seem almost universal.
    \end{itemize}
}
